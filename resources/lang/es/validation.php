...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'TelefonoD' => 'Teléfono de Domicilio',
        'TelefonoC' => 'Teléfono Celular',
        'InstitucionD' => 'Institución destino',
        'Pais' => 'País',
        'ProgramaP' => 'Programa al que postulará',
        'Idioma' => 'Idioma en el que se imparten las asignaturas',
        'FechaI' => 'Fecha de Inicio',
        'FechaT' => 'Fecha de Término',
        'SemestreE' => 'Semestre lectivo equivalente',      
        'Materias' => 'Propuesta de asignaturas a cursar',
        'PropuestaA' => 'Propuesta de asignaturas que se revalidarían en el IM',
        'Observaciones' => 'Observaciones o comentarios adicionales',
        'Motivos' => 'Exposición de motivos',
        'HistorialA' => 'Historial académico',
        'CurriculumV' => 'Curriculum',
        'SeguroM' => 'Seguro médico',
        'IdentificacionO' => 'Identificación oficial',
        'CertificadoI' => 'Certificado de idioma',
    ],
